...
For the figures which I make, these are the following assumptions:
* `dpi = 300`;
* the tile provider is Thunderforest and `scale = 2`; and
* `resample = False`.

Bearing that in mind, then the choices made are (in order):
